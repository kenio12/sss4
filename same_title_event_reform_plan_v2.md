...
## 📅 実装スケジュール（10-15日間・3フェーズ）

### フェーズ1: データ構造改修（2-3日間）
- ✅ **完了**: Novel.eventフィールド追加
- ✅ **完了**: genreを通常ジャンルに変更
- ⏳ **残り**: データ移行スクリプト作成・実行（1-2日）
- ⏳ **残り**: is_same_title_game=True保持確認 + 動作テスト（1日）

### フェーズ2: UI・機能改修（5-7日間）
- ⏳ 一覧画面に「イベント」列追加（1-2日）
- ⏳ 詳細画面に「イベント」表示追加（1日）
- ⏳ 「俺もこのタイトルで作る」ボタン実装（2-3日）
- ⏳ エントリー制廃止（1日）
...
- ⏳ 同タイトル提案通知（1日）
- ⏳ 同タイトル決定通知（1日）
- ⏳ 配信停止機能（既存システム活用で0.5日）
- ⏳ EmailNotificationSettingsモデル作成（0.5日）

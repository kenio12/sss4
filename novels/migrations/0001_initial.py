    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('draft', '作成中'), ('published', '公開')], default='draft', max_length=10)),
                ('genre', models.CharField(choices=[('レジェンド小説', 'レジェンド小説'), ('初めましての挨拶', '初めましての挨拶'), ('ジョーク', 'ジョーク'), ('シリーズ', 'シリーズ'), ('サスペンス', 'サスペンス'), ('ファンタジー', 'ファンタジー'), ('同タイトル', '同タイトル'), ('恋愛', '恋愛'), ('日常', '日常'), ('祭り', '祭り'), ('雑談', '雑談'), ('ミステリー', 'ミステリー'), ('ノンフィクション', 'ノンフィクション'), ('ホラー', 'ホラー'), ('時代', '時代'), ('未分類', '未分類'), ('バトル', 'バトル'), ('大会', '大会'), ('コメディ', 'コメディ'), ('オフ会', 'オフ会'), ('歴史', '歴史'), ('私小説', '私小説'), ('官能', '官能'), ('三題噺', '三題噺'), ('旧祭り', '旧祭り'), ('旧同タイトル', '旧同タイト���')], default='未分類', max_length=100)),
